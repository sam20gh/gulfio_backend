...
const MAX_ARTICLES = 4; // Mobile optimized - minimal articles for speed
const VECTOR_INDEX_NAME = 'vec_full'; // New vector search index with embedding field
const VECTOR_CANDIDATES = 150; // Mobile optimized - aggressive reduction
const VECTOR_LIMIT = 10; // Mobile optimized - minimal candidates
const BM25_LIMIT = 8; // Mobile optimized - minimal BM25 candidates
const RERANK_CANDIDATES = 8; // Mobile optimized - minimal rerank candidates
